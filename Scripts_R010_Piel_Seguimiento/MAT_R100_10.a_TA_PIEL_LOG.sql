...
EXECUTE [dbo].[PG_CI_TIPO_PIEL_LOG] 0, 0, 11, 'CAMBIO COLOR',					'CAMB_COLOR', 11, '', 1
EXECUTE [dbo].[PG_CI_TIPO_PIEL_LOG] 0, 0, 12, 'INGRESO MANUAL',					'INGRE_MANU', 12, '', 1
EXECUTE [dbo].[PG_CI_TIPO_PIEL_LOG] 0, 0, 13, 'IMPRESION TICKET',				'IMP_TICKET', 13, '', 1
EXECUTE [dbo].[PG_CI_TIPO_PIEL_LOG] 0, 0, 14, 'DEVOLUCION DE PIEL POR PRD',		'DEVCON_PRD', 14, '', 1
EXECUTE [dbo].[PG_CI_TIPO_PIEL_LOG] 0, 0, 15, 'TRASPASO DE PIEL POR PRD',		'TRSPSO_PRD', 15, '', 1
EXECUTE [dbo].[PG_CI_TIPO_PIEL_LOG] 0, 0, 16, 'BORRAR REIMPRESION',				'DL_IMPRESA', 16, '', 1
GO
