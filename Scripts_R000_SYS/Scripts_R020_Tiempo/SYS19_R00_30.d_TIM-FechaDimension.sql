...
EXECUTE [dbo].[PG_CI_TIEMPO_FECHA_X_RANGO]	0, 0, '2025-01-01', '2026-01-01'
EXECUTE [dbo].[PG_CI_TIEMPO_FECHA_X_RANGO]	0, 0, '2026-01-01', '2027-01-01'
EXECUTE [dbo].[PG_CI_TIEMPO_FECHA_X_RANGO]	0, 0, '2027-01-01', '2028-01-01'
EXECUTE [dbo].[PG_CI_TIEMPO_FECHA_X_RANGO]	0, 0, '2028-01-01', '2029-01-01'
EXECUTE [dbo].[PG_CI_TIEMPO_FECHA_X_RANGO]	0, 0, '2029-01-01', '2030-01-01'
-- ===============================================
EXECUTE [dbo].[PG_CI_TIEMPO_FECHA_X_RANGO]	0, 0, '2030-01-01', '2031-01-01'
