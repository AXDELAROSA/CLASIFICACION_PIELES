...
EXECUTE [dbo].[PG_CI_SISTEMA]	0, 0,    0, 'DEFAULT',				'SYS/DEF'
EXECUTE [dbo].[PG_CI_SISTEMA]	0, 0,  100, 'ICS/GENERAL',			'ICS'
EXECUTE [dbo].[PG_CI_SISTEMA]	0, 0,  200, 'ERM/GENERAL',			'ERM'
EXECUTE [dbo].[PG_CI_SISTEMA]	0, 0, 1001, 'PRESTAMOS MAYORISTAS',	'PR3M4'
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CI_TABLA_SISTEMA]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CI_TABLA_SISTEMA]
GO


CREATE PROCEDURE [dbo].[PG_CI_TABLA_SISTEMA]
	@PP_L_DEBUG					INT,
	@PP_K_SISTEMA_EXE			INT,
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CI_EQUIVALENCIA]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CI_EQUIVALENCIA]
GO


CREATE PROCEDURE [dbo].[PG_CI_EQUIVALENCIA]
	@PP_L_DEBUG						INT,
	@PP_K_SISTEMA_EXE				INT,
	@PP_K_SISTEMA					INT,
