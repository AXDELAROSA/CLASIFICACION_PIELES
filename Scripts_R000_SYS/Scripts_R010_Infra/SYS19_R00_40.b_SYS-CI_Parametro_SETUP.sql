...
EXECUTE [dbo].[PG_CI_PARAMETRO]			0, 0, 
										...
										100, 'SISTEMA',	'SISTEMA', 10, 'SISTEMA = K_SISTEMA | #0000 DEFAULT | #0100 ICS/GENERAL | #0200 ERM/GENERAL | #1001 TRANSPORTADORA ', 1 
GO

-- SISTEMA = K_SISTEMA | #0000 DEFAULT | #0100 ICS/GENERAL | #0200 ERM/GENERAL | #1001 PRESTAMOS MAYORISTAS 
EXECUTE [dbo].[PG_CI_VALOR_PARAMETRO]	0, 0, 0,
										--1000, 'SISTEMA', 'ENTERO_1 = K_SISTEMA | #0000 DEFAULT | #0100 ICS/GENERAL | #0200 ERM/GENERAL | #1001 PRESTAMOS MAYORISTAS ',
										1000, 'SISTEMA', 'ENTERO_1 = K_SISTEMA | #0000 DEFAULT | #0100 ICS/GENERAL | #0200 ERM/GENERAL | #1001 TRANSPORTADORA ',
										0,	100, 
										'TXT_1', 'TXT_2', 'TXT_3', 
...
AS
	-- EXECUTE [dbo].[PG_CI_PARAMETRO]	100, 'SISTEMA',	'SISTEMA', 10, 'SISTEMA = K_SISTEMA | #0000 DEFAULT | #0100 ICS/GENERAL | #0200 ERM/GENERAL | #1001 PRESTAMOS MAYORISTAS ', 1 
...
AS
	-- EXECUTE [dbo].[PG_CI_PARAMETRO]	101, 'AMBIENTE',	'AMBIENTE', 10, '#0 N/A | #1 PROD | #2 PERF | #3 UAT | #4 CERT | #5 LAB | #6 UNIT | #7 DESA', 1 
...
EXECUTE [dbo].[PG_CI_VALOR_PARAMETRO]	0, 0, 1001,
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ======================
	-- EXECUTE PG_CI_PARAMETRO 102, 'VIGENCIA CONTRASEÑA',	'PWD', 10, 'PARAMETRO = @PP_DIAS_VIGENCIA', 1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ======================
	-- EXECUTE PG_CI_PARAMETRO 103, 'DEFAULT CONTRASEÑA','PWD', 10, 'PARAMETRO = @PP_DEFAULT_PASSWORD', 1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ==========================
	-- EXECUTE PG_CI_PARAMETRO 104, 'MOSTRAR ERROR DE SQL',	'SQLERR', 10, 'PARAMETRO = @PP_ERROR_SQL_SHOW', 1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ======================
	-- EXECUTE PG_CI_PARAMETRO 105, 'MOSTRAR REGISTROS BORRADOS',	'MAXRW', 10, 'PARAMETRO = @PP_SHOW_DELETE', 1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- =========================
	-- EXECUTE PG_CI_PARAMETRO 201, 'MOSTRAR [#KK]',	'KCMBX', 10, 'PARAMETRO = @PP_SHOW_K', 1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ====================================
	-- EXECUTE PG_CI_PARAMETRO 202, 'RENGLONES EN LISTADO',	'MAXRW', 10, 'PARAMETRO = @PP_MAXROWS', 1
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ====================================
	-- EXECUTE PG_CI_PARAMETRO 203, 'RENGLONES EN LISTADO/PESADO',	'MAXRW', 10, 'PARAMETRO = @PP_MAXROWS', 1 
