...
-- ==========================================
EXECUTE [dbo].[PG_CI_SISTEMA]  0000, 'DEFAULT',	'DEFAULT',		'DEFAULT',0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  0010, 'ICS',		'ICS',			'ICS', 0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  0020, 'ERM',		'ERM',			'ERM', 0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  0040, 'PPT0',	'PRESUPUESTOS','Presupuestos',0, 1, 0, '2018-08-06', 0, '2018-08-06', 0
-- ==========================================
EXECUTE [dbo].[PG_CI_SISTEMA]  0101, 'G4SPR',	'G4S / SICOM',	'G4S',0, 1, 0, '2018-08-06', 0, '2018-08-06', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  0102, 'TRKJK',	'TRACKJACK',	'TRKJK',0, 1, 0, '2018-08-06', 0, '2018-08-06', 0
-- ==========================================
...
EXECUTE [dbo].[PG_CI_SISTEMA]  2006, 'ADG18',	'AGATA',		'ADG18', 0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  2007, 'PYF18',	'ISAAC',		'PYF18', 0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  2008, 'GEO19',	'(?)GEO19',		'GEO19', 0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
EXECUTE [dbo].[PG_CI_SISTEMA]  2009, 'G2G19',	'(?)G2G19',		'G2G19', 0, 1, 0, '2018-04-02', 0, '2018-04-02', 0
-- ==========================================
GO
